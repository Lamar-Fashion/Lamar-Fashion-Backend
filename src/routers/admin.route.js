...
// adminRouter.put('/product', bearerAuth, permissions('edit'), editProductHandler);
// adminRouter.delete('/product', bearerAuth, permissions('delete'), deleteProductHandler);
// adminRouter.put('/order', bearerAuth, permissions('edit'), editOrderHandler);
